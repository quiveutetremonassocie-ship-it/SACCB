      ...
      <div className="section-pad relative">
        ...
        >
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            Le <span className="text-[#1e3a5f] font-semibold">SACCB</span> est l&apos;une des associations de
            badminton de Sainte-Adresse. Un esprit convivial, du jeu pour tous les niveaux et une équipe
