  ...
  return (
    <div className="glass p-6">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h3 className="font-display text-2xl tracking-wider text-white">Inscriptions tournois</h3>
      </div>
      {(db.config_tournois || []).map((t) => {
        ...
        return (
          <div key={t.id} className="mb-5">
            <p className="bg-blue-500/20 text-blue-300 px-3 py-2 rounded-xl font-semibold mb-2">
              {t.name}
            </p>
            <div className="space-y-1">
              {inscrits.map((i) => (
                ...
                >
                  <span className="text-white text-sm">{i.joueurs}</span>
