...
export default function StatsAdhesions({
  ...
  return (
    <div className="glass p-6 border border-blue-200 text-center">
      <div className="flex items-center justify-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center">
          <TrendingUp className="w-5 h-5 text-white" />
        </div>
        <h3 className="font-display text-2xl tracking-wider text-slate-800">Stats Adhésions</h3>
      </div>
      <p className="text-5xl font-display text-emerald-600 my-4">{totals.totalRecolte}€</p>
